...
var modal_config_defaults_const_1 = require('./modal-config-defaults.const');
var class_name_const_1 = require('./class-name.const');
var selector_const_1 = require('./selector.const');
...
var ModalDirective = (function () {
    ...
    ModalDirective.prototype.show = function () {
        ...
        if (this.document && this.document.body) {
            this.renderer.setElementClass(this.document.body, class_name_const_1.ClassName.OPEN, true);
        }
    ...
    ModalDirective.prototype.hide = function (event) {
        ...
        this._isShown = false;
        this.renderer.setElementClass(this.element.nativeElement, class_name_const_1.ClassName.IN, false);
    ...
    ModalDirective.prototype.getConfig = function (config) {
        return Object.assign({}, modal_config_defaults_const_1.modalConfigDefaults, config);
    };
    /**
     *  Show dialog
     */
    ModalDirective.prototype.showElement = function () {
        ...
        this.renderer.setElementClass(this.element.nativeElement, class_name_const_1.ClassName.IN, true);
    ...
    ModalDirective.prototype.hideModal = function () {
        ...
        this.showBackdrop(function () {
            if (_this.document && _this.document.body) {
                _this.renderer.setElementClass(_this.document.body, class_name_const_1.ClassName.OPEN, false);
            }
    ...
    ModalDirective.prototype.setScrollbar = function () {
        ...
        var fixedEl = this.document.querySelector(selector_const_1.Selector.FIXED_CONTENT);
        if (!fixedEl) {
            return;
        }
    ...
    ModalDirective.prototype.getScrollbarWidth = function () {
        ...
        scrollDiv.className = class_name_const_1.ClassName.SCROLLBAR_MEASURER;
